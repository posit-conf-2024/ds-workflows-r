...
-   Use push-button publishing to publish this document, with source code, to Connect. Or publish using `rsconnect::deployApp(envVars = c("WSDOT_ACCESS_CODE"))`-   Schedule it to run on a timescale that seems appropriate for the data update cycle
