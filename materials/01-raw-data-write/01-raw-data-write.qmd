...
💡 Don't split hairs over what part of your string is captured as the
...
💡 Consider `format: email` as an extension of the more general
...
::: callout
❗❗ When viewing this portion of the code in the Workshop, switch from
