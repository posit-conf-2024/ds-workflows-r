...
vesselinfo_raw <- dplyr::tbl(con, 
                             DBI::Id(
                               ...
                               name = paste0("vesselinfo_raw_",Sys.getenv("DATABASE_SCHEMA")))) |> collect()

vesselhistory_raw <- dplyr::tbl(con, 
                                DBI::Id(
                                  schema = Sys.getenv("DATABASE_SCHEMA"), 
                                  name = paste0("vesselhistory_raw_",Sys.getenv("DATABASE_SCHEMA")))) |> collect()

weather_terminal_history_raw <- dplyr::tbl(con, 
                                           DBI::Id(
                                             schema = Sys.getenv("DATABASE_SCHEMA"), 
                                             name = paste0("weather_terminal_history_raw_",Sys.getenv("DATABASE_SCHEMA")))) |> collect()
