...
vesselinfo_raw <- dplyr::tbl(con, DBI::Id("deckhand", "vesselinfo_raw_deckhand")) |> collect()

vesselhistory_raw <- dplyr::tbl(con, DBI::Id("deckhand", "vesselhistory_raw_deckhand")) |> collect()

weather_terminal_history_raw <- dplyr::tbl(con, DBI::Id("deckhand", "weather_terminal_history_raw_deckhand")) |> collect()
