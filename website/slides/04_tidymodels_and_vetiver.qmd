...
👉 Open the file `materials/04-tidymodels-vetiver/04-idymodels-vetiver.qmd`
...
👉 Open the file `materials/04-tidymodels-vetiver/04-tidymodels-vetiver.qmd`
...
-   What if the model training is slow or the data is **REALLY** big?
    ...
    -   {{< bi sign-turn-right-fill color=orange >}} Workbench Jobs allows you to run R scripts in new sessions independent of your current RStudio Pro session
...
## Ferry Delay Prediction Model {.content-light}

::: {.callout-note icon="false"}
## Activity

👉 Try interacting with your Ferry Delay Prediction Model API on Posit Connect
:::

## Example Prediction

![](slide_resources/example_prediction.png){fig-align="center"}
