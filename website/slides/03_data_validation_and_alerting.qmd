...
:::{.callout-note icon=false}
## Activity
👉 Activity objective: Change the `CONDITION_OVERRIDE` environment variable in `.Renviron` and see the output for Conditions 1, 2, and 3. Look in the `email_preview` folder for the email output after each rendering.

- Return to the file `03-data-clean-validate.qmd` 
- We will work through **Task 9 to the end of the notebook**
