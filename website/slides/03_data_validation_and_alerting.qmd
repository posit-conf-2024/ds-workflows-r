...
## A {{< bi sign-turn-right-fill color=orange >}} on managing environments

<h4>Don't change your code to switch between development and production environments</h4>

:::{.fragment}
🧰 Update environment variables to change behavior 
```{.r}
...
<br>
🧰 Use `{config}` as another approach to manage environment
